...
/* info section setup */
//var fsRow = document.querySelector(".info__row--full-screen");
//if (fsRow) fsRow.style.height = window.innerHeight - navHeight - bodywrapperMarginTop - bodywrapperMarginBottom - 50 + "px";
...
if (sidebar) {
  ...
  for (var i = 0; i < rows.length; i++) {
    ...
    if (i != rows.length-1 || i == 0 /* <-- this last condition is TEMP */) {
